        ...
        var TableDatatablesEditable = function () {
            ...
            var handleTable = function () {
                ...
                function editRow(oTable, nRow) {
                    ...
                    jqTds[4].innerHTML = '<input type="text" class="form-control input-small" onclick="layui.laydate({elem: this})" value="' + aData[4] + '">';
                ...
                function ajaxSaveOrUpdate(oTable, nRow) {
                    ...
                    if (aData[0] !== '') {
                        order_update(id, no, orderTime, customer, deliveryTime, downpayment, comments, {
                            success: function (result) {
                                if (result.code === 0) {
...
//                                    oTable.fnUpdate("预定", nRow, 6, false);
                        ...
                        order_add(orderTime, customer, deliveryTime, downpayment, comments, {
                            success: function (result) {
                                if (result.code === 0) {
                                    var data = result.data;
